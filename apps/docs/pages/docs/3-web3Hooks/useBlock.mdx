...
# useBlock
This hook can be used to fetch the latest or any past block's information. This could also be used to subscribe to new blocks and be able to trigger events based on that.

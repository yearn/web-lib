...
# useBalance
This hook can be used to fetch balance information for the ETH coin or any ERC20 token. This includes the user's balance, the token price, the token symbol and the decimals.

...
│   ├── useWeb3.tsx                 # Context wrapping your dApp enabling you unleash the Web3 features
...
│   ├── useAccount.tsx              # Web3 Hook remapping the useWeb3 context for easier DX
│   ├── useBalance.tsx              # Web3 Hook to fetch balance information for the ETH coin or any ERC20 token
...
│   ├── performBatchedUpdates.tsx   # Utility function to update multiple state in one React render
│   ├── providers.tsx               # Bunch of utility functions to access the defaults Web3 providers and multicall initializator.

...
├── style.css
|
├── contexts/                       # Access via: @majorfi/web-lib/contexts
...
|
├── hooks/                          # Access via: @majorfi/web-lib/hooks
...
|
├── utils/                          # Access via: @majorfi/web-lib/utils
...
|
├── components/                     # Access via: @majorfi/web-lib/components
│   └── *.tsx                       # List of components available in the library
|
├── icons/                          # Access via: @majorfi/web-lib/icons
│   └── *.tsx                       # List of SVG icons components available in the library
|
└── layouts/                        # Access via: @majorfi/web-lib/layouts

...
<Nextra.Tabs items={['npm', 'yarn']}>
	<Nextra.Tab>
		```bash
		npm i @majorfi/web-lib ethers tailwindcss
		```
	</Nextra.Tab>
	<Nextra.Tab>
		```bash
		yarn add @majorfi/web-lib ethers tailwindcss
		```
	</Nextra.Tab>
</Nextra.Tabs>
...
```tsx
{
	"compilerOptions": {
		...
		"baseUrl": ".",
		"paths": {
			"@majorfi/web-lib/components": ["./node_modules/@majorfi/web-lib/dist/components"],
			"@majorfi/web-lib/layouts": ["./node_modules/@majorfi/web-lib/dist/layouts"],
			"@majorfi/web-lib/contexts": ["./node_modules/@majorfi/web-lib/dist/contexts"],
			"@majorfi/web-lib/hooks": ["./node_modules/@majorfi/web-lib/dist/hooks"],
			"@majorfi/web-lib/icons": ["./node_modules/@majorfi/web-lib/dist/icons"],
			"@majorfi/web-lib/utils": ["./node_modules/@majorfi/web-lib/dist/utils"]
		}	
	}
}
```

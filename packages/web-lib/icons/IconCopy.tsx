	...
	return (
		<svg
			...
			<path
				fillRule={'evenodd'}
				clipRule={'evenodd'}
				d={'M5 4.33334C3.34323 4.33334 2 5.70144 2 7.38889V12.2778C2 13.9652 3.34323 15.3333 5 15.3333H7.4C9.05677 15.3333 10.4 13.9652 10.4 12.2778V7.38889C10.4 5.70144 9.05677 4.33334 7.4 4.33334H5ZM3.2 7.38889C3.2 6.37646 4.00597 5.55556 5 5.55556H7.4C8.39403 5.55556 9.2 6.37646 9.2 7.38889V12.2778C9.2 13.2902 8.39403 14.1111 7.4 14.1111H5C4.00597 14.1111 3.2 13.2902 3.2 12.2778V7.38889Z'}
				fill={'currentcolor'}/>
		</svg>
	);
}

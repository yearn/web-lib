import { DAY, fromWeeks, getTimeUntil, roundToWeek, SECOND, toMilliseconds, toSeconds, toTime, toWeeks, WEEK } from '../../src/utils/time';
describe('timeUtils', () => {
    test('toTime', () => {
        ...
        expect(() => toTime('invalid')).toThrowError('Invalid input: Cannot convert "invalid" to a number.');
    });
    test('toMilliseconds', () => {

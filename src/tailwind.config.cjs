...
module.exports = {
	...
	safelist: [
		...
		{pattern: /(text|bg|border)-(background|surface|primary|secondary)/, variants: ['hover']},
		{pattern: /(text|bg|border)-(background|surface|primary|secondary)-(variant)/, variants: ['hover']},
		{pattern: /(text|bg|border)-(alert)-(warning|error|critical)-(primary|secondary)/, variants: ['hover']},
		{pattern: /(text|bg|border)-(alert)-(warning)-(secondary)-(variant)/, variants: ['hover']},
		{pattern: /(text|bg|border)-(icons)-(primary|variant)/, variants: ['hover']},
		{pattern: /(text|bg|border)-(typo)-(primary|secondary)/, variants: ['hover']},
		{pattern: /(text|bg|border)-(typo)-(primary|secondary)-(variant)/, variants: ['hover']},
		{pattern: /(text|bg|border)-(off|disabled|dark)/, variants: ['hover']},
		{pattern: /(text|bg|border)-(button)-(filled|outlined|disabled)-(primary|variant|text)/, variants: ['hover']},
	],
	theme: {
		extend: {
			gridTemplateColumns: {

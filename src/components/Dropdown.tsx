...
function Dropdown({options, defaultOption, selected, set_selected}: TDropdownProps): ReactElement {
	return (
		<div>
				...
				{({open}): ReactElement => (
					<>
						...
						<Transition
							...
							<Menu.Items className={'flex overflow-y-scroll absolute left-0 flex-col mt-1 w-full max-h-60 rounded-lg border-0 bg-background-variant'}>
